...
if (strlen($levelString) > $maxLevelLength) exit("-1");
...
if (strlen($levelName) > 64 OR strlen($levelDesc) > 1024) exit("-1");
if (!is_numeric($objects) OR $objects > 100000) $objects = 0;
if (!is_numeric($coins) OR $coins > 3) $coins = 0;
if (!is_numeric($requestedStars) OR $requestedStars > 10) $requestedStars = 0;
